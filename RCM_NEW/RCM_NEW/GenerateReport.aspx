...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 col-md-12">
            ...
            <div class="col-lg-8 cl-md-12" style="">
        ...
        <div class="col-lg-4 cl-md-12" >
            <asp:Button class="btn btn-primary" ID="GenerateReportButton" runat="server" OnClick="GenerateReportButton_Click" style="width: 100%; margin-top: 27px; float: right" BackColor="#9E1B34" Text="Generate Report" />
            <asp:Button class="btn btn-default" ID="ExportDataButton" runat="server" style="width: 100%; margin-bottom: 10px; margin-top: 10px; float: right" Text="Export Data" />
        </div>
    </div>
    </div>
