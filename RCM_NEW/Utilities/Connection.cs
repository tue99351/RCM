...
namespace Utilities
{
    public class DBConnect
    {
      ...
      //  String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa14_3342_tue99351;User id=tue99351;Password=iedaiSh1";
        String SqlConnectString= "Server=(localdb)\\Projects; Database=RCM; Integrated Security=true";
